 ...
 * Class that use sqlight to give persistance to the app. We store only favored movies.
 */

public class StoreDB extends ContentProvider {
    static final String PROVIDER_NAME = "ortino.andrea.set08114.movieseeker.provider.Movies";
