...
public class ImageAdapter extends BaseAdapter {
    ...
    // each element of the array call once this method and returns the corrected sized box image.
    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Use of picasso to load the image from the path (base url + array containing the rest of the path size 1, 1.5
        // If image does not load -> it shows place holder instead
